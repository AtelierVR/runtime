# Script de build pour le mod MaliciousMod
...
$ModName = "malicious_test"
$ModId = "com.example.malicious_test"

Write-Host "========================================" -ForegroundColor Cyan
Write-Host "  Building MaliciousMod (Security Test)" -ForegroundColor Cyan
Write-Host "========================================" -ForegroundColor Cyan
...
if ($dotnetPath) {
    ...
    try {
        dotnet build MaliciousMod.csproj -c Release -o "$ModOutputPath"
