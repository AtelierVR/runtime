# Script de build pour le mod HelloWorld
...
$ModName = "hello_world"
$ModId = "com.example.helloworld"

Write-Host "========================================" -ForegroundColor Cyan
Write-Host "  Building HelloWorld Mod" -ForegroundColor Cyan
Write-Host "========================================" -ForegroundColor Cyan
...
if ($dotnetPath) {
    ...
    try {
        dotnet build HelloWorldMod.csproj -c Release -o "$ModOutputPath"
    ...
    $cscArgs = "/target:library /out:`"$ModOutputPath\HelloWorldMod.dll`" $refArgs $sourceArgs"
