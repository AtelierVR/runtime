...
#pragma warning restore CS0659 // Type overrides Object.Equals(object o) but does not override Object.GetHashCode()
    {
        ...
        public List<Instance> Instances => InstanceManager.Get(Id);
        ...
        public void Update()
        {
            ...
            if (_lastLatencyRequest.AddSeconds(CCK.Constants.IntervalLantencyRequest) < DateTime.Now)
            {
        ...
        public async UniTask<Handshakes.ResponseHandshake> RequestHandshake()
        {
            ...
            {
                Engine = CCK.Constants.CurrentEngine,
                Platform = CCK.Constants.CurrentPlatform,
                ProtocolVersion = CCK.Constants.ProtocolVersion,
            };
