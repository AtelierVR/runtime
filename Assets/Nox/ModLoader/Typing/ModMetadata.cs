...
namespace Nox.ModLoader.Typing
{
    ...
    public class ModMetadata : CCK.Mods.Metadata.ModMetadata
    {
        ...
        /// </summary>
        /// <returns></returns>
        public CCK.Mods.Metadata.Person[] GetAuthors() => GetInternalAuthors();

        internal Person[] GetInternalAuthors() => _authors;

        /// <summary>
        /// Get the contact of the mod.
        /// </summary>
        /// <returns></returns>
        public CCK.Mods.Metadata.Contact GetContact() => GetInternalContact();

        internal Contact GetInternalContact() => _contact;

        /// <summary>
        /// Get the contributors of the mod.
        /// </summary>
        /// <returns></returns>
        public CCK.Mods.Metadata.Person[] GetContributors() => GetInternalContributors();

        internal Person[] GetInternalContributors() => _contributors;
        ...
        /// </summary>
        /// <returns></returns>
        public CCK.Mods.Metadata.Relation[] GetRelations() => GetInternalRelations();

        internal Relation[] GetInternalRelations() => _relations;

        /// <summary>
        /// Get relation of the mod that breaks.
        /// </summary>
        /// <returns></returns>
        public CCK.Mods.Metadata.Relation[] GetBreaks() => GetInternalBreaks();

        internal Relation[] GetInternalBreaks() => _relations
        ...
        /// </summary>
        /// <returns></returns>
        public CCK.Mods.Metadata.Relation[] GetConflicts() => GetInternalConflicts();

        internal Relation[] GetInternalConflicts() => _relations
        ...
        /// </summary>
        /// <returns></returns>
        public CCK.Mods.Metadata.Relation[] GetDepends() => GetInternalDepends();

        internal Relation[] GetInternalDepends() => _relations
        ...
        /// </summary>
        /// <returns></returns>
        public CCK.Mods.Metadata.Relation[] GetRecommends() => GetInternalRecommends();

        internal Relation[] GetInternalRecommends() => _relations
        ...
        /// </summary>
        /// <returns></returns>
        public CCK.Mods.Metadata.Relation[] GetSuggests() => GetInternalSuggests();

        internal Relation[] GetInternalSuggests() => _relations
        ...
        /// </summary>
        /// <returns></returns>
        public CCK.Mods.Metadata.Entries GetEntryPoints() => GetInternalEntryPoints();

        internal Entries GetInternalEntryPoints() => _entryPoints;

        /// <summary>
        /// Get the references of the mod.
        /// </summary>
        /// <returns></returns>
        public CCK.Mods.Metadata.Reference[] GetReferences() => GetInternalReferences();

        internal Reference[] GetInternalReferences() => _references;

        /// <summary>
        /// Get the side of the mod.
        /// </summary>
        /// <returns></returns>
        public SideFlags GetSide() => _sides;
        ...
        /// </summary>
        /// <returns></returns>
        public Dictionary<string, object> GetCustoms() => _customs.ToObject<Dictionary<string, object>>();
        ...
        public bool HasCustom<T>(string key) => _customs.ContainsKey(key);
