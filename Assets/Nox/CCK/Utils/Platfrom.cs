...
namespace Nox.CCK.Utils
{
    ...
    public static class PlatformExtensions
    {
        ...
        public static Platform GetPlatformFromName(string name) => name switch
        {
        ...
        public static Platform CurrentPlatform
        {
            ...
            set
            {
                var target = GetBuildTarget(value);
...
#if UNITY_EDITOR
        public static Platform GetPlatform(this BuildTarget target) => target switch
        {
        ...
        public static BuildTarget GetBuildTarget(this Platform platform) => platform switch
        {
