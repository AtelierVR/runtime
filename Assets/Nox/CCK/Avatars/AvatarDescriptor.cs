...
namespace Nox.CCK.Avatars
{
    public class AvatarDescriptor : MonoBehaviour
    {
        ...
        public EyeLook GetLeftEye() => Array.Find(eyeLooks, e => e.placement == EyePlacement.Left);
        public EyeLook GetRightEye() => Array.Find(eyeLooks, e => e.placement == EyePlacement.Right);
