...
namespace Nox.CCK.Avatars
{
    ...
    public class AvatarDescriptorEditor : Editor
    {
        ...
        public override VisualElement CreateInspectorGUI()
        {
            ...
            viewPosition.RegisterValueChangedCallback(e =>
            {
            ...
            voicePosition.RegisterValueChangedCallback(e =>
            {
            ...
            voiceParent.RegisterValueChangedCallback(e =>
            {
            ...
            useEyeMovements.RegisterValueChangedCallback(e =>
            {
            ...
            eyeTargetSlider.RegisterValueChangedCallback(e =>
            {
            ...
            eyeTargetMin.RegisterValueChangedCallback(e =>
            {
            ...
            eyeTargetMax.RegisterValueChangedCallback(e =>
            {
            ...
            eyeLookType.RegisterValueChangedCallback(e =>
            {
            ...
            faceMesh.RegisterValueChangedCallback(e =>
            {
            ...
            previewEyeY.RegisterValueChangedCallback(e =>
            {
            ...
            previewEyeX.RegisterValueChangedCallback(e =>
            {
            ...
            previewEyeYValue.RegisterValueChangedCallback(e =>
            {
                previewEyeLook.y = e.newValue;
            ...
            previewEyeXValue.RegisterValueChangedCallback(e =>
            {
                previewEyeLook.x = e.newValue;
        ...
        private VisualElement MakeEyeBlendShape(AvatarDescriptor descriptor)
        {
            ...
            var lookUp = item.Q<DropdownField>("look-up");
            lookUp.RegisterValueChangedCallback(e =>
            {
                if (item.userData is not (int i and >= 0) || i >= descriptor.eyeLooks.Length) return;
            ...
            var lookDown = item.Q<DropdownField>("look-down");
            lookDown.RegisterValueChangedCallback(e =>
            {
                if (item.userData is not (int i and >= 0) || i >= descriptor.eyeLooks.Length) return;
            ...
            var lookLeft = item.Q<DropdownField>("look-left");
            lookLeft.RegisterValueChangedCallback(e =>
            {
                if (item.userData is not (int i and >= 0) || i >= descriptor.eyeLooks.Length) return;
            ...
            var lookRight = item.Q<DropdownField>("look-right");
            lookRight.RegisterValueChangedCallback(e =>
            {
                if (item.userData is not (int i and >= 0) || i >= descriptor.eyeLooks.Length) return;
            ...
            limitUp.RegisterValueChangedCallback(e =>
            {
                if (item.userData is not (int i and >= 0) || i >= descriptor.eyeLooks.Length) return;
                descriptor.eyeLooks[i].angleLimits.y = e.newValue;
                limitUpDownSlider.SetValueWithoutNotify(new Vector2(
            ...
            limitDown.RegisterValueChangedCallback(e =>
            {
                if (item.userData is not (int i and >= 0) || i >= descriptor.eyeLooks.Length) return;
            ...
            limitLeft.RegisterValueChangedCallback(e =>
            {
                if (item.userData is not (int i and >= 0) || i >= descriptor.eyeLooks.Length) return;
                descriptor.eyeLooks[i].angleLimits.z = e.newValue;
                limitLeftRightSlider.SetValueWithoutNotify(new Vector2(
            ...
            limitRight.RegisterValueChangedCallback(e =>
            {
                if (item.userData is not (int i and >= 0) || i >= descriptor.eyeLooks.Length) return;
            ...
            limitUpDownSlider.RegisterValueChangedCallback(e =>
            {
                if (item.userData is not (int i and >= 0) || i >= descriptor.eyeLooks.Length) return;
            ...
            limitLeftRightSlider.RegisterValueChangedCallback(e =>
            {
                if (item.userData is not (int i and >= 0) || i >= descriptor.eyeLooks.Length) return;
        ...
        private void OnSceneGUI()
        {
            ...
            else if (descriptor.eyeLookType == AvatarDescriptor.EyeLookType.Transform)
            {
                ...
                foreach (var eye in eyes)
                {
                    ...
                    Handles.color = Color.green;
                    var rotation = Quaternion.Euler(-previewEyeLook.x, previewEyeLook.y, 0);
                    var forward = rotation * Vector3.forward;
                    var position = eyeTarget.position + forward * 0.1f;
                    Handles.DrawLine(eyeTarget.position, position);
                }
            }
        }
    }
