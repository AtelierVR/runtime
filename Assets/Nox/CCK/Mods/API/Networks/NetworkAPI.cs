...
// {
//     public interface NetworkAPI : ShareObject<NetworkAPI>
//     {
//     }
// }
...
// //     {
// //         public UniTask<ShareObject> GetWorld(string server, uint worldId, bool withEmpty = false);
// //         public UniTask<ShareObject> GetAsset(string server, uint worldId, uint assetId);
// //         public UniTask<ShareObject> UpdateAsset(UpdateAssetData asset);
...
// //         public UniTask<ShareObject> CreateAsset(CreateAssetData asset);
// //         public UniTask<ShareObject> CreateWorld(CreateWorldData world);
// //         public UniTask<ShareObject> UpdateWorld(UpdateWorldData world, bool withEmpty = false);

// //         public UniTask<ShareObject[]> GetWorlds(string server, uint[] worldIds);
// //         public UniTask<ShareObject> SearchWorlds(string server, string query, uint offset = 0, uint limit = 10);
// //     }
