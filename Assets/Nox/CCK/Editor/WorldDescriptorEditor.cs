...
namespace Nox.CCK.Editor.Worlds
{
    ...
    public class MainDescriptorEditor : UnityEditor.Editor
    {
        ...
        private static SuppordBuildTarget _buildTarget = SuppordBuildTarget.NoTarget;
        ...
        {
            BuildWorld(null, SuppordBuildTarget.NoTarget, true);
        }

        public static BuildResult BuildWorld(MainDescriptor descriptor = null, SuppordBuildTarget buildTarget = SuppordBuildTarget.NoTarget, bool dialog = true)
        {
            _building = true;
            ...
            if (buildTarget == SuppordBuildTarget.NoTarget)
