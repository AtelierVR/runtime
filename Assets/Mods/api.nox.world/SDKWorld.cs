...
// {
//     [InitializeOnLoad, CCKMod("api.nox.world", "0.0.1")]
//     public class CCKWorld : CCKDescriptor
//     {
//         internal VisualElement _root = new();
//         internal MainDescriptor[] Descriptors => MainDescriptorEditor.GetWorldDescriptors(false);
//         private WorldPublisher _worldPublisher = null;

//         public override void OnCCKLoad()
//         {
//             _worldPublisher ??= new WorldPublisher(this);
//             _root.ClearBindings();
//             _root.Clear();
//             _worldPublisher.OnLoad();
...
//             _root.ClearBindings();
//             _root.Clear();
//             _worldPublisher.OnUnload();
//         }

//         public override void OnCCKUpdate()
//         {
//             _worldPublisher.OnUpdate();
//             if (!CCKPanel.HasTab("api.nox.world.builder") && !CCKPanel.HasTab("api.nox.world.publisher")) return;
...
//                         Actions = new List<VisualElement>
//                         {
//                             new Button(() => CCKPanel.Goto("api.nox.user")) { text = "Login" }
//                         }
//                     });
...
//             var buildPlatform = descriptor != null ? descriptor.GetBuildPlatform() : SuppordBuildTarget.NoTarget;
//             if (buildPlatform == SuppordBuildTarget.NoTarget && !NotificationManager.Has("NoBuildPlatform"))
//                 NotificationManager.Set(new Notification
//                 {
//                     Uid = "NoBuildPlatform",
//                     Type = NotificationType.Error,
...
//                     }
//                 });
//             else if (buildPlatform != SuppordBuildTarget.NoTarget && NotificationManager.Has("NoBuildPlatform"))
...
//                 if (descriptor != null && descriptor.target != (SuppordBuildTarget)target.value)
...
//         [CCKTab("api.nox.world.builder", "World/Builder")]
//         public VisualElement WorldTab(bool selected = false)
//         {
//             if (!selected)
//             {
//                 _root.ClearBindings();
...
//             _root.ClearBindings();
//             _root.Clear();
//             _root.Add(Resources.Load<VisualTreeAsset>("api.nox.world.ui").CloneTree());
//             _root.Q<Label>("version").text = "v" + Version;
//             var descriptor = Descriptors.Length > 0 ? Descriptors[0] : null;
//             _root.Q<EnumField>("platform-field").Init(descriptor?.GetBuildPlatform() ?? SuppordBuildTarget.NoTarget);
//             _root.Q<ObjectField>("descriptor-field").value = descriptor;
//             _root.Q<Button>("goto-publisher").clicked += () => CCKPanel.Goto("api.nox.world.publisher");
...
//         [CCKTab("api.nox.world.loader", "World/Loader")]
//         public VisualElement LoaderTab(bool selected = false) => WorldLoader.OpenTab(selected);

//         [CCKTab("api.nox.world.publisher", "World/Publisher")]
//         public VisualElement PublisherTab(bool selected = false) => _worldPublisher.OpenTab(selected);
//     }
