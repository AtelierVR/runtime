...
namespace api.nox.world {
	public class AssetLoadedWorld : BaseLoadedWorld {
		...
		public static async UniTask<AssetLoadedWorld> Load(string ns, string path, Action<float> progress, CancellationToken token) {
			progress?.Invoke(0f);
