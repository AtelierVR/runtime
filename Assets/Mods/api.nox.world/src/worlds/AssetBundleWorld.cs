...
namespace api.nox.world {
	public class AssetBundleWorld : BaseWorld {
		...
		public static async UniTask<AssetBundleWorld> Load(string path, Action<float> progress, CancellationToken token) {
			progress?.Invoke(0f);
