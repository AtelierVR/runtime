...
namespace api.nox.world {
	public abstract class BaseLoadedWorld : ILoadedWorld, INoxObject {
		internal string       Id;
		...
		internal void OnSelect(BaseLoadedWorld oldLoadedWorld) {
		...
		internal void OnDeselect(BaseLoadedWorld newLoadedWorld) {
