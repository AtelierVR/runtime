...
namespace Nox.SimplyLibs
{
    ...
    {
        [ShareObjectExport, ShareObjectImport] public Func<UniTask<ShareObject>> SharedGetMyServer;
        [ShareObjectExport, ShareObjectImport] public Func<string, string, uint, uint, UniTask<ShareObject>> SharedSearchServers;
