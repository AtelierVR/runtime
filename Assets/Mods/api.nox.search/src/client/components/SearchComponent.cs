...
//             {
//                 var asset = Main.CoreAPI.AssetAPI.GetAsset<GameObject>("prefabs/worker.prefab");
...
//                 ? Main.CoreAPI.AssetAPI.GetAsset<Texture2D>("ui", "icons/apps.png")
//                 : handler.Icon;
...
//                 var asset = Main.CoreAPI.AssetAPI.GetAsset<GameObject>("prefabs/handler.prefab");
//                 asset.SetActive(false);
