...
namespace Nox.CCK.YantraJS {
	...
	public class YantraScript : MonoBehaviour, IYantraScript {
		/// <summary>
		/// The YantraJS script asset that this script is based on.
		/// Is a .js file.
		/// </summary>
		public YantraFile asset;

		/// <summary>
		/// Is a Json string that contains the exports of the YantraJS script.
		/// </summary>
		[SerializeField]
		private ExportEntry[] exports = Array.Empty<ExportEntry>();


		private IYantraBacking _backing;

		// ReSharper disable Unity.PerformanceAnalysis
		public IYantraBacking GetBacking()
			=> _backing ??= GetComponent<IYantraBacking>();
