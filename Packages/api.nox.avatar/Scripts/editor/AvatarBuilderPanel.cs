...
// 			AvatarNotificationHelper.Clear();
// 			_lastHashNotify = "";
// 			_root.ClearBindings();
// 			_root.Clear();
//
...
// 				AvatarDescriptorHelper.CurrentAvatar = newDescriptor;
// 			}
// 		}
//
...
// 			// Utiliser l'avatar courant de l'AvatarEditorHelper
// 			var mainDescriptor = AvatarDescriptorHelper.CurrentAvatar;
...
// 			if (!AvatarNotificationHelper.Has(uid)) return;
...
// 			get {
// 				if (AvatarDescriptorHelper.CurrentAvatar != null) {
// 					return new[] { AvatarDescriptorHelper.CurrentAvatar };
// 				}
//
...
// 			var notify = AvatarNotificationHelper.Notifications;
...
// 		}
//
// 		private VisualElement CreateModernNotificationItem(AvatarNotification notificationManager, VisualElement item) {
...
// 		}
//
// 		private void CreateNotificationItem(AvatarNotification notificationManager, VisualTreeAsset asset) {
